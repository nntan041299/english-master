    ...
    return (
      <Screen>
        <div className="bg-white/5 border border-white/10 rounded-2xl px-8 py-10">
          ...
          <h1 className="text-lg font-semibold text-white mb-2" style={{ fontFamily: 'var(--font-display)' }}>
            Sign-in failed
          </h1>
          <p className="text-sm text-white/50 mb-8 leading-relaxed" style={{ fontFamily: 'var(--font-sans)' }}>
            {message}
          </p>
          <button
  ...
  return (
    <Screen>
      <div className="bg-white/5 border border-white/10 rounded-2xl px-8 py-10">
        ...
        <p className="text-sm text-white/50 mb-8" style={{ fontFamily: 'var(--font-sans)' }}>
